...
IL_008a_1:
			{
				...
				int32_t L_29 = V_10;
				NullCheck(L_28);
				VirtualActionInvoker1< uint8_t >::Invoke(27, L_28, (uint8_t)((int32_t)(uint8_t)L_29));
				int32_t L_30 = V_4;
...
IL_00cc_1:
			...
			}
			{
				...
				NullCheck(L_59);
				int64_t L_60;
				L_60 = VirtualFuncInvoker0< int64_t >::Invoke(10, L_59);
			...
			}
			{
				...
				L_62 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(31, L_61);
				V_15 = L_62;
				...
				NullCheck(L_69);
				VirtualActionInvoker1< int64_t >::Invoke(21, L_69, ((int64_t)0));
			}
...
IL_023e_1:
			{
				...
				NullCheck(L_117);
				NullCheck(L_115);
				VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(25, L_115, L_116, 0, ((int32_t)(((RuntimeArray*)L_117)->max_length)));
				int32_t L_118 = V_1;
				V_2 = L_118;
				il2cpp_codegen_runtime_class_init_inline(Decoder_t16FBEA8705FE41EBB2B2E331FB7B9664283C2F64_il2cpp_TypeInfo_var);
...
IL_0270_1:
			{
				...
				NullCheck(L_124);
				int64_t L_125;
				L_125 = VirtualFuncInvoker0< int64_t >::Invoke(10, L_124);
			...
			}
			{
				...
				L_127 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(31, L_126);
				V_19 = L_127;
